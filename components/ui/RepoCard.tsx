...
const RepoCard = ({ repo }: { repo: GithubRepository }) => {
    ...
    const description = project?.description ? project.description : repo.description;
    return (
        <li key={repo.id} className="flex flex-col gap-3 py-4 px-5 hover:bg-zinc-500/10 transition-colors duration-200">
