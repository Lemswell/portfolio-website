  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-20">
      <header className="my-8">
        <Link
          href="/"
          className="text-xl sm:text-2xl font-bold tracking-tight text-blue-950 dark:text-blue-400
        ...
        <p className="text-sm justify-center whitespace-pre-line text-zinc-800/60 dark:text-zinc-100/60
          tracking-normal font-medium font-mono mt-3">
